...
function SignupComponent() {
  ...
  for (let k = 1; k <= 1500; k++) {
    elements.push(
      <div
        key={k}
        className="transition-colors duration-[1.5s] hover:duration-[0s] border-[#00FF00] h-[calc(5vw-2px)] w-[calc(5vw-2px)] md:h-[calc(4vw-2px)] md:w-[calc(4vw-2px)] lg:h-[calc(3vw-4px)] lg:w-[calc(3vw-4px)] bg-gray-900 hover:bg-[#06b6d4]"
      ></div>
    );
  }
          ...
          <div className="w-[100vw] h-[100vh] px-3 sm:px-5 flex items-center justify-center absolute">
            <div className="w-full sm:w-1/2 lg:2/3 px-6 bg-gray-500 bg-opacity-20 bg-clip-padding backdrop-filter backdrop-blur-sm text-white z-50 py-4 rounded-lg">
              ...
              <div className="flex flex-row justify-between">
                ...
                <Link to='/login' className="text-[#06b6d4] text-sm md:text-md hover:cursor-pointer">SIGN IN</Link>
              </div>
